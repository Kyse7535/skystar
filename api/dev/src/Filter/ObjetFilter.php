...
final class ObjetFilter implements FilterInterface
{
    ...
    public function apply(Request $request, bool $normalization, array $attributes, array &$context){
        ...
        $constellation = $request->query->all('constellation');
        $raRange = $request->query->get("raRange");
        $decaRange = $request->query->get("decaRange");
        $magnitudeRange = $request->query->get("magnitudeRange");
        ...
        $context["raRange"] = $raRange;
        $context["decaRange"] = $decaRange;
        $context["magnitudeRange"] = $magnitudeRange;
